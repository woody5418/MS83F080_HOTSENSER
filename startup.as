	...
	; Compiler options:
	;
	; -oms83f080_hotsenser.cof -mms83f080_hotsenser.map --summary=default \
	; --output=default main.p1 myconfiguration.p1 myeeprom.p1 mykey.p1 \
	; myadc.p1 --chip=16F685 -P --runtime=default --opt=default -D__DEBUG=1 \
